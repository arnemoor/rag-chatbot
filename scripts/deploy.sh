...
echo ""
echo "🔗 Main URLs:"
echo "  • Worker API:     ${GREEN}$WORKER_URL${NC}"
echo "  • Widget Home:    ${GREEN}$WIDGET_URL${NC}"
echo ""
echo "🎯 Test Your Deployment:"
echo "  • Chat Interface: ${BLUE}$WIDGET_URL${NC}"
echo "  • Demo Page:      ${BLUE}$WIDGET_URL/demo.html${NC}"
echo "  • Playground:     ${BLUE}$WIDGET_URL/playground.html${NC}"
echo "  • R2 Browser:     ${BLUE}$WIDGET_URL/r2browser.html${NC}"
echo ""
echo "📋 Integration Code (add to your website):"
echo ""
echo "  ${YELLOW}<script src=\"$WIDGET_URL/autorag-widget.min.js\"></script>${NC}"
echo "  ${YELLOW}<autorag-widget></autorag-widget>${NC}"
echo ""
